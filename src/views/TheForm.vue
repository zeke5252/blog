	...
	<form v-on:submit.prevent>
		<div class="row justify-content-end">
			<div class="col-5 col-sm-2">
				<button type="button" class="btn col-12" v-on:click="signOutHandler">Sign out</button>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="group--container" :style="displayImages.length > 0 && 'height: 30vh'">
				<div class="group--container__photo" v-for="(image, index) in displayImages" :key="index">
					<img :src="image" />
					<button class="btn btn-primary m-0 mb-1 d-block py-1 px-2" @click="copySrc(index)">Copy</button>
					<button class="btn btn-primary m-0 mb-1 d-block py-1 px-2" @click="copySrc(index, true)">Paste to content</button>
					<button class="btn m-0 mb-1 d-block py-1 px-2 text-white bg-dark" @click="removeImage(index)">Remove</button>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<button class="btn col-12 col-sm-2 mb-3 me-2" v-on:click="setDraft(content)">Save draft</button>
		<button type="submit" class="btn btn-primary btn col-12 col-sm-2 mb-3" v-on:click="submitHandler">Submit</button>
