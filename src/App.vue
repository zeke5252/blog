...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg">
	<symbol id="logo" x="0" y="0" viewBox="0 0 342 131.9" >
    <defs>
      <circle id="clipJP" cx="64.3" cy="67.5" r="64.3"/>
    </defs>
    <clipPath id="clipJP_1_">
      <use xlink:href="#clipJP"  style="overflow:visible;"/>
    </clipPath>
    <g id="jpGroup">
...
export default {
  ...
  setup(props) {
    ...
    const isActive = path => {
        ...
        return result !== path ? { opacity: .2 } : { opacity: 1 };
    };
...
<style lang="scss">
  ...
  .st{
	...
	#leafs{
    clip-path:url(#clipCircle_1_);
  }
  #jpGroup{
    clip-path:url(#clipJP_1_);
  }
  #leafSpin{
    transform: scale(2);
